...
namespace Saro.BT.Designer
{
    public static class EditorSingleDrag
    {
        ...
        {
            SetSubtreePosition(node, null, position, offset);
        }
        ...
        public static void SetSubtreePosition(BonsaiNode root, IEnumerable<BonsaiNode> otherNodes, Vector2 dragPosition, Vector2 offset)
        {
            ...
            if (otherNodes != null)
            {
                ...
                foreach (BonsaiNode node in otherNodes)
                {
