...
namespace Saro.BT.Designer
{
    public class BonsaiWindow : EditorWindow
    {
        ...
        public BehaviorTree Tree { get { return behaviourTree; } }
        ...
        void Update()
        {
            ...
            bool bConditions =
                Editor.EditorMode == BonsaiEditor.Mode.View &&
        ...
        public bool ContainsNode(BTNode behaviour)
        {
        ...
        public void SetTree(BehaviorTree bt, BonsaiEditor.Mode mode = BonsaiEditor.Mode.Edit)
        {
            behaviourTree = bt;
            BuildCanvas();
        ...
        private void DrawToolbar()
        {
            ...
            {
                if (Editor.EditorMode == BonsaiEditor.Mode.Edit)
                {
        ...
        private void Load()
        {
            ...
            BehaviorTree tree = Saver.LoadBehaviourTree();
            if (tree)
            {
                SetTree(tree);
            }
