...
namespace Saro.BT.Designer
{
    ...
    public static class Drawer
    {
        ...
        /// <summary>
        /// draw preorder index of this node
        /// </summary>
        /// <param name="node"></param>
        private static void DrawPreOrderIndex(BonsaiNode node)
        {
            GUI.DrawTexture(
                node.PreOrderIndexRect,
                BonsaiPreferences.Instance.breakPoint,
                ScaleMode.StretchToFill,
                true,
                0f,
            ...
            GUI.Label(
                node.PreOrderIndexRect,
                node.Behaviour.PreOrderIndex.ToString(),
                node.PreOrderIndexStyle
                );
        }
        ...
        private static Color NodeTypeColor(BonsaiNode node)
        {
            ...
            else if (node.Behaviour is BTService)
            {
