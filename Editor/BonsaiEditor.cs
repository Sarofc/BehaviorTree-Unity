...
namespace Bonsai.Designer
{
    ...
    public class BonsaiEditor
    {
        ...
        public event EventHandler<Mode> OnEditorModeChanged;
        public Mode EditorMode
        {
            ...
            set
            {
                ...
                {
                    m_EditorMode = value;
                    OnEditorModeChanged?.Invoke(this, value);
                }
            }
        }

        private Mode m_EditorMode = Mode.View;
        ...
        private void SetBreakPoint(BonsaiNode seletedNode, bool breakpoint)
        {
            ...
            if (seletedNode.Behaviour == null) return;
        ...
        private void BeginActionOnMouseDown(object sender, BonsaiInputEvent inputEvent)
        {
            ...
            if (inputEvent.IsPortFocused() && EditorMode == Mode.Edit)
            {
        ...
        private void DoubleClicked(object sender, BonsaiInputEvent inputEvent)
        {
            ...
            {
                // Open sub-tree
                var include = inputEvent.node.Behaviour as RunSubtree;
                if (include)
                {
        ...
        private void StartAreaSelection(BonsaiInputEvent startEvent)
        {
            ...
            ApplyAction = (BonsaiInputEvent applyEvent) =>
            {
                ...
                if (areaSelection != null) NodeSelection.SetMultiSelection(areaSelection.ToList());
            };
        ...
        public bool IsEditMode { get { return EditorMode == Mode.Edit; } }
        ...
        public static Type CoreType(BTNode behaviour)
        {
            if (behaviour is BTComposite)
            {
